...
@section('main-content')
    ...
    <div class="flex justify-between items-center w-full p-2 mb-4 bg-slate-100 rounded-xl">
        ...
        <a href="{{ route('admin.ruangan.detail.create', ['room' => $room->id, 'type' => 'material']) }}"
    ...
    <div class="grid grid-cols-4 gap-4 mb-20">
        @foreach ($materials as $detail)
            <livewire:card-room-detail :detail="$detail" :filter="'material'" />
        @endforeach
    ...
    <div class="flex justify-between items-center w-full p-2 mb-4 bg-slate-100 rounded-xl">
        ...
        <a href="{{ route('admin.ruangan.detail.create', ['room' => $room->id, 'type' => 'peralatan']) }}"
            class="p-3 font-bold text-white bg-primary-green rounded-lg hover:bg-green-500">
            Tambah Baru
        </a>
    </div>
    <div class="grid grid-cols-4 gap-4 mb-20">
        @foreach ($tools as $detail)
            <livewire:card-room-detail :detail="$detail" :filter="'tool'" />
        @endforeach
        <div class="col-span-4">
