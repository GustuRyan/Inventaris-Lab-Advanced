        ...
        <div class="w-full flex-1 flex items-center justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5">
                    {!! __('Showing') !!}
                    <span class="font-medium">{{ $tools->firstItem() }}</span>
                    {!! __('to') !!}
                    <span class="font-medium">{{ $tools->lastItem() }}</span>
                    {!! __('of') !!}
                    <span class="font-medium">{{ $tools->total() }}</span>
                    {!! __('results') !!}
                </p>
            </div>
